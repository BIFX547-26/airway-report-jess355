...
If the interactive app below does not load, open this page through a web server such as GitHub Pages, Posit Connect, or `python3 -m http.server`. Shinylive will not run correctly when the HTML file is opened directly from disk.
